# mixed_always_accel_demo.s -- Phase 16 baseline: same
# 12-workload stream, every block forced to the accelerator path.

    li   x29, 0x20000000
    li   x30, 0xDEADBEEF

# -- block m0: vecadd N=1 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m1: vecadd N=2 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m2: dot N=4 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m3: matmul N=2 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m4: vecadd N=4 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m5: dot N=8 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m6: vecadd N=8 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m7: matmul N=4 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m8: dot N=16 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m9: vecadd N=16 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m10: dot N=32 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block m11: vecadd N=32 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
