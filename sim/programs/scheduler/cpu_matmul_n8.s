# cpu_matmul_n8.s -- Phase 13 scheduler dataset: CPU-only 8x8
# matrix multiply. Generated from
# sim/programs/benchmarks/cpu_matmul_bench.s's structure (Phase 11);
# the loop bound N and the "i*N"/"k*N" address shift (3 =
# log2(8)) both differ -- see this generator script's own header
