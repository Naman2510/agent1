# cpu_matmul_n2.s -- Phase 13 scheduler dataset: CPU-only 2x2
# matrix multiply. Generated from
# sim/programs/benchmarks/cpu_matmul_bench.s's structure (Phase 11);
# the loop bound N and the "i*N"/"k*N" address shift (1 =
# log2(2)) both differ -- see this generator script's own header
