# always_accel_demo.s -- Phase 15 baseline: same 6-workload stream,
# every block forced to the accelerator path (no decision logic).

    li   x29, 0x20000000
    li   x30, 0xDEADBEEF

# -- block blk0: vecadd N=1 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block blk1: vecadd N=2 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block blk2: vecadd N=4 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block blk3: dot N=1 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block blk4: dot N=4 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
...
# -- block blk5: matmul N=2 (forced accelerator) --
    li   x1, 805306368
    li   x2, 0x1000
    li   x3, 0x2000
    add  x2, x1, x2
