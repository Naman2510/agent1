...
make unit-test         # runs every automated test suite in the repo: 96 tests
                        # (storage_sim 48, telemetryd 19, oob_control 14, dashboard 15)
...
unit-test` passes all 96 tests, `sim-test` runs a real, executed RAID1
